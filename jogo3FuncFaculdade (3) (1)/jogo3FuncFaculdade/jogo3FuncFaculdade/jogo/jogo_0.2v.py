...
class Menu:
    def __init__(self, tela, fonte):
        ...
        self.botao_comecar = Button("Começar", (LARGURA // 2, ALTURA // 2), fonte, (255, 255, 255), (255, 255, 0))
        self.botao_sair = Button("Sair", (LARGURA // 2, ALTURA // 2 + 60), fonte, (255, 255, 255), (255, 255, 0))
