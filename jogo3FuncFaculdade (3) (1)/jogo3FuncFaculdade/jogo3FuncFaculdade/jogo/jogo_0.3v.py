...
class Moeda(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.frames = [
            pygame.image.load('png/gold/gold_21.png').convert_alpha(),
            pygame.image.load('png/gold/gold_22.png').convert_alpha(),
            pygame.image.load('png/gold/gold_24.png').convert_alpha(),
            pygame.image.load('png/gold/gold_25.png').convert_alpha(),
            pygame.image.load('png/gold/gold_26.png').convert_alpha(),
            pygame.image.load('png/gold/gold_27.png').convert_alpha(),
            pygame.image.load('png/gold/gold_28.png').convert_alpha(),
            pygame.image.load('png/gold/gold_29.png').convert_alpha(),
            pygame.image.load('png/gold/gold_30.png').convert_alpha(),
            pygame.image.load('png/gold/gold_21.png').convert_alpha()
        ]

        self.frames = [pygame.transform.scale(frame, (18, 18)) for frame in self.frames]
...
class Boneca(pygame.sprite.Sprite):
    def __init__(self, jogador):
        super().__init__()
        imagem_original = pygame.image.load(r"png\boneca\boneca.png").convert_alpha()
...
class Remo(pygame.sprite.Sprite):
    def __init__(self, boneca):
        ...
        # Offset do remo em relação ao centro da boneca (ajuste conforme sua imagem)
        self.offset_x = 10
        self.offset_y = 15
